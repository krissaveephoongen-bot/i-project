...
export type TimeEntryStatusType =
...
export type StakeholderRoleType =
  (typeof StakeholderRole)[keyof typeof StakeholderRole];
export type StakeholderTypeType =
  (typeof StakeholderType)[keyof typeof StakeholderType];
export type InvolvementLevelType =
  (typeof InvolvementLevel)[keyof typeof InvolvementLevel];
...
export type AuditEventTypeType =
...
export type RiskProbabilityType =
...
export function getPriorityLabel(
  priority: TaskPriorityType | ProjectPriorityType,
  lang: "en" | "th" = "en",
): string {
  const labels: Record<string, Record<string, string>> = {
    en: {
