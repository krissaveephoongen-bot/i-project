    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      {error && (
        <div className="border border-red-200 bg-red-50 text-red-700 rounded p-3 flex items-center justify-between">
          ...
          <button onClick={load} className="px-3 py-1 rounded border border-red-300 hover:bg-red-100">
            ลองอีกครั้ง
          </button>
        </div>
      )}
        ...
        <div className="overflow-x-auto border rounded">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {payments.length === 0 && (
                <tr>
                  <td className="px-4 py-10 text-slate-500 text-center" colSpan={8}>
                    ...
                    <button onClick={load} className="mt-3 px-3 py-1.5 rounded bg-slate-100 hover:bg-slate-200">
                      โหลดใหม่
                    </button>
                  </td>
                </tr>
