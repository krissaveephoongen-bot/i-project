...
export default function ApprovalModal({ isOpen, mode, label, onClose, onConfirm }: ApprovalModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[520px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {mode === 'approve' ? 'ยืนยันการอนุมัติรายการนี้' : 'กรุณาระบุเหตุผลการปฏิเสธ (ถ้ามี)'}
            {label ? ` - ${label}` : ''}
          </DialogDescription>
        </DialogHeader>
