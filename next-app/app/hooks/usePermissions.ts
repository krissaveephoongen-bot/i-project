...
export function usePermissions() {
  ...
  const permissions = useMemo(
    () => ({
      ...
      canCreateProjects: () =>
        hasPermission(userRole, Permission.PROJECT_CREATE),
      canEditProjects: () => hasPermission(userRole, Permission.PROJECT_UPDATE),
      canDeleteProjects: () =>
        hasPermission(userRole, Permission.PROJECT_DELETE),
      canManageProjects: () =>
        hasPermission(userRole, Permission.PROJECT_MANAGE),
      ...
      canApproveTimesheets: () =>
        hasPermission(userRole, Permission.TIMESHEET_APPROVE),
      canApproveExpenses: () =>
        hasPermission(userRole, Permission.EXPENSE_APPROVE),
      ...
      canConfigureSystem: () =>
        hasPermission(userRole, Permission.SYSTEM_CONFIG),
