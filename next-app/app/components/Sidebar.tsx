...
const NavItem = ({ item, isActive, isExpanded, onToggleExpand, onNavigate }: NavItemProps) => {
                    ...
                    {item.children!.map((child) => (
                        <li key={child.name}>
                            <Link
                                href={child.href}
                                onClick={onNavigate}
                                aria-current={currentPathname === child.href ? 'page' : undefined}
                                className={clsx(
                                    'flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
            ...
            <div className="p-4 border-t border-border space-y-2">
                ...
                <div className="p-3 bg-muted/50 rounded-lg border border-border">
                    <div className="flex items-center gap-3">
                        ...
                        <Link href="/settings" className="text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded" aria-label="ตั้งค่า">
