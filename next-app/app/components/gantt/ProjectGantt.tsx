...
import { Gantt, Task as GanttTask, ViewMode, EventOption } from 'gantt-task-react';
  ...
  const ganttTasks: GanttTask[] = tasks.map((task) => {
    ...
    return {
      ...
      styles: {
        ...
        progressSelectedColor: task.status === 'Completed' ? '#16a34a' : '#2563eb',
        backgroundColor: task.status === 'Completed' ? '#dcfce7' : '#dbeafe',
        backgroundSelectedColor: task.status === 'Completed' ? '#bbf7d0' : '#bfdbfe',
      },
    };
  });
