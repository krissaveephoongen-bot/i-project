          ...
          <tbody>
            {data.map((member, idx) => (
              <tr key={idx} className="border-b border-slate-100">
                <td className="py-2 px-2 text-xs font-medium text-slate-700 truncate max-w-[80px]">
                  {member.name}
                </td>
