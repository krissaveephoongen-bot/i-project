  ...
  try {
    ...
    return NextResponse.json({
      ...
      performance: {
        ...
        fastest_test: Math.min(...testResults.map(t => t.details.time_ms || t.details.set_time_ms || 0)),
        slowest_test: Math.max(...testResults.map(t => t.details.time_ms || t.details.set_time_ms || 0))
      }
    });
