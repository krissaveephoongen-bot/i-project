export const PROJECT_ID_COLUMNS = ['project_id', 'projectId', 'projectid'] as const;
export const MILESTONE_ID_COLUMNS = ['milestone_id', 'milestoneId', 'milestoneid'] as const;
...
export async function firstOk<T>(columns: readonly string[], run: (col: string) => Promise<T>) {
  let last: any = null;
