...
const sampleData = [
  { id: '1', name: 'Project Alpha', status: 'active', category: 'Development', priority: 'high', manager: 'John Doe' },
  { id: '2', name: 'Project Beta', status: 'planning', category: 'Design', priority: 'medium', manager: 'Jane Smith' },
  { id: '3', name: 'Project Gamma', status: 'completed', category: 'Marketing', priority: 'low', manager: 'Bob Johnson' },
  { id: '4', name: 'Project Delta', status: 'active', category: 'Development', priority: 'high', manager: 'Alice Brown' },
  { id: '5', name: 'Project Epsilon', status: 'planning', category: 'Research', priority: 'medium', manager: 'Charlie Wilson' },
]
...
export default function FilterTestPage() {
  ...
  const filteredData = useMemo(() => {
    ...
    if (isLoading) return sampleData // Show all data during loading
  ...
  }, [sampleData, searchTerm, statusFilter, categoryFilter, priorityFilter, managerFilter, showError, isLoading])
        ...
        <CardContent>
          ...
          <div className="mt-4 p-4 bg-muted rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
              ...
              <div>Error: {showError ? 'Yes' : 'No'}</div>
              <div>Loading: {isLoading ? 'Yes' : 'No'}</div>
              <div>Results: {filteredData.length}/{sampleData.length}</div>
            </div>
          </div>
        </CardContent>
      </Card>
