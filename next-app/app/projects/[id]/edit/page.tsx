...
import { getProjects, updateProject, Project as ProjectType } from '@/app/lib/projects';
...
export default function EditProjectPage() {
  ...
  const { data: projectsData, isLoading, error } = useQuery<ProjectType[]>({
    queryKey: ['projects'],
    queryFn: getProjects,
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8 pt-24">
        <ProjectForm
          project={project}
          onSave={(saved) => updateMutation.mutate({ id: project.id, updatedFields: saved })}
