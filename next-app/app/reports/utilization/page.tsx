 ...
 export default function UtilizationPage() {
   ...
   useEffect(() => {
     const load = async () => {
       const u = new URL('/api/reports/utilization/', window.location.origin);
   ...
   return (
     <div className="min-h-screen">
       <div className="pt-20 px-6 pb-6">
         <h1 className="text-2xl font-semibold text-slate-900 mb-4">Utilization per Person (Total Hours)</h1>
