...
const LazyExecutiveTab = createLazyComponent(
  () => import("./components/ExecutiveTab"),
  {
    loadingVariant: "card",
...
const LazyProjectsTab = createLazyComponent(
  () => import("./components/ProjectsTab"),
  {
...
const LazyFinancialTab = createLazyComponent(
  () => import("./components/FinancialTab"),
  {
    loadingVariant: "card",
    loadingClassName: "min-h-[400px]",
  },
...
const LazyResourcesTab = createLazyComponent(
  () => import("./components/ResourcesTab"),
  {
    loadingVariant: "card",
    loadingClassName: "min-h-[400px]",
  },
...
const LazyInsightsTab = createLazyComponent(
  () => import("./components/InsightsTab"),
  {
            ...
            <div>
              ...
              <p className="text-slate-500 mt-1">
                ...
                <span className="ml-2 text-slate-400">
                  (External projects only; internal/department costs excluded)
                </span>
              </p>
            </div>
