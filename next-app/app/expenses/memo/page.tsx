...
export default function MemoRequestPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const docNo = `MEMO-${new Date().getFullYear()}-${Math.floor(Math.random() * 1000).toString().padStart(3, '0')}`; // Simple auto-gen
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      <Header title="Memo Request" breadcrumbs={[{ label: 'Expenses', href: '/expenses' }, { label: 'Memo Request' }]} />
      ...
      <div className="container mx-auto px-6 py-8 pt-24 space-y-6 max-w-4xl">
        <div className="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 className="text-2xl font-bold text-slate-900">New Memo Request</h1>
                <p className="text-slate-500">Submit a formal request or memo for approval</p>
            </div>
        </div>
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium">Content / Justification</label>
                    <Textarea 
