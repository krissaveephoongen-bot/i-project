...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  [UserRole.ADMIN]: [
    // All permissions
    Permission.PROJECT_CREATE, Permission.PROJECT_READ, Permission.PROJECT_UPDATE, Permission.PROJECT_DELETE, Permission.PROJECT_MANAGE,
    Permission.TASK_CREATE, Permission.TASK_READ, Permission.TASK_UPDATE, Permission.TASK_DELETE, Permission.TASK_ASSIGN,
    Permission.TIMESHEET_CREATE, Permission.TIMESHEET_READ, Permission.TIMESHEET_UPDATE, Permission.TIMESHEET_APPROVE,
    Permission.EXPENSE_CREATE, Permission.EXPENSE_READ, Permission.EXPENSE_UPDATE, Permission.EXPENSE_APPROVE,
    Permission.USER_CREATE, Permission.USER_READ, Permission.USER_UPDATE, Permission.USER_DELETE,
    Permission.REPORT_READ, Permission.REPORT_EXPORT, Permission.REPORT_ADMIN,
    Permission.SYSTEM_CONFIG, Permission.AUDIT_READ,
  ],
  [UserRole.MANAGER]: [
    // Project management
    Permission.PROJECT_CREATE, Permission.PROJECT_READ, Permission.PROJECT_UPDATE, Permission.PROJECT_MANAGE,
    // Task management
    Permission.TASK_CREATE, Permission.TASK_READ, Permission.TASK_UPDATE, Permission.TASK_ASSIGN,
    // Time and expense approval
    Permission.TIMESHEET_READ, Permission.TIMESHEET_APPROVE,
    Permission.EXPENSE_READ, Permission.EXPENSE_APPROVE,
  ...
  [UserRole.EMPLOYEE]: [
    ...
    // Time tracking
    Permission.TIMESHEET_CREATE, Permission.TIMESHEET_READ, Permission.TIMESHEET_UPDATE,
    // Expenses
...
export function canAccessProject(userId: string, userRole: UserRole, projectManagerId?: string): boolean {
...
export function canAccessTask(userId: string, userRole: UserRole, taskAssigneeId?: string, projectManagerId?: string): boolean {
  ...
  if (userRole === UserRole.MANAGER && projectManagerId && userId === projectManagerId) {
    return true;
  }
