...
export async function updateTimesheetApproval(id: string, action: 'approve' | 'reject', payload?: { reason?: string; approvedBy?: string }) {
...
export async function updateExpenseApproval(id: string, action: 'approve' | 'reject', payload?: { reason?: string; approvedBy?: string }) {
