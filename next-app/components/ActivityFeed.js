    ...
    if (loading) {
      return (
        <div
          ...
          data-file="components/ActivityFeed.js"
        >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="p-1 hover:bg-[var(--secondary-color)] rounded-lg transition-colors"
          >
        ...
        <div className="space-y-4">
          {activities.length > 0 ? (
            activities.map((activity) => (
              <div
                key={activity.id}
                className="flex items-start space-x-3 p-2 rounded-lg hover:bg-[var(--secondary-color)] transition-colors"
              >
                <div
                  className={`w-8 h-8 rounded-full bg-white border-2 flex items-center justify-center flex-shrink-0 ${
                ...
                >
                  <div
                    className={`icon-${getActivityIcon(activity.type)} text-sm ${getActivityColor(activity.type)}`}
                  ></div>
                </div>
