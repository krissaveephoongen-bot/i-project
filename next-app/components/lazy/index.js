...
const ErrorFallback = ({ error, reset }) => (
  <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
    ...
    <p className="text-gray-600 mb-4">{error.message || 'Failed to load component'}</p>
    <button
      onClick={reset}
...
export function createLazyComponent(importFunc, loadingComponent = LoadingFallback, options = {}) {
