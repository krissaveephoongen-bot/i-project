...
export type TimesheetWeek = Database['public']['Tables']['timesheet_weeks']['Row']
export type TimesheetWeekInsert = Database['public']['Tables']['timesheet_weeks']['Insert']
export type TimesheetWeekUpdate = Database['public']['Tables']['timesheet_weeks']['Update']
