 ...
 async function main() {
  try {
    await pool.query(`ALTER TABLE sales_pipelines ADD COLUMN IF NOT EXISTS "createdAt" timestamptz DEFAULT NOW();`);
    await pool.query(`ALTER TABLE sales_pipelines ADD COLUMN IF NOT EXISTS "updatedAt" timestamptz DEFAULT NOW();`);
    await pool.query(`ALTER TABLE sales_stages ADD COLUMN IF NOT EXISTS "createdAt" timestamptz DEFAULT NOW();`);
    await pool.query(`ALTER TABLE sales_stages ADD COLUMN IF NOT EXISTS "updatedAt" timestamptz DEFAULT NOW();`);
    await pool.query(`ALTER TABLE sales_deals ADD COLUMN IF NOT EXISTS "createdAt" timestamptz DEFAULT NOW();`);
    await pool.query(`ALTER TABLE sales_deals ADD COLUMN IF NOT EXISTS "updatedAt" timestamptz DEFAULT NOW();`);
  } catch {}
