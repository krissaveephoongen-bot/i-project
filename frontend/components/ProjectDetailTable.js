  ...
  try {
    ...
    return (
      <div className="bg-white rounded-xl p-6 shadow-sm border border-[var(--slate-200)]">
        <h3 className="font-bold text-[var(--navy-900)] mb-4">รายการงานในโครงการ</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b-2 border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-semibold">ความคืบหน้า</th>
            ...
            <tbody>
              {tasks.length === 0 ? (
                ...
                tasks.map(task => {
                  ...
                  return (
                    <tr key={task.objectId} className="border-b border-gray-100 hover:bg-gray-50">
