...
const FormEnhanced: React.FC<FormProps> = ({
  title,
  description,
  sections,
  onSubmit,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ 
        submit: (error as any)?.message || 'การส่งงานล้วลม กรุณากรุณอุมัติ กรุณากรุณอุมัติ',
      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-end space-x-4 pt-6">
          ...
          >
            {isSubmitting ? (
              <>
                <div className="inline-block h-4 w-4 mr-2 animate-spin rounded-full border-2 border-transparent" />
                <span>กำลงงาน...</span>
              </>
            ) : (
              <>
