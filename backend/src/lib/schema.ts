import { pgTable, text, timestamp, decimal, boolean, integer, uuid, index } from 'drizzle-orm/pg-core';
...
export const tasks = pgTable('tasks', {
  ...
  // Assignment
  assignedTo: text('assigned_to').references(() => users.id, 'assigned_to'),
  createdBy: text('created_by').references(() => users.id, 'created_by'),
...
// Re-export vendor tables from vendor-schema
export { 
  vendorContracts, 
...
// Placeholder exports for missing tables
export const actualLaborCosts = timesheets;
export const laborRates = users;
export const taskDependencies = tasks;
