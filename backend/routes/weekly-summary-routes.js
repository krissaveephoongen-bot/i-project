...
import { WeeklySummaryService } from '../src/features/projects/services/weekly-summary.service.js';
...
router.get('/', async (req, res) => {
  try {
    const filters = {
      ...
      weekNumber: req.query.weekNumber ? parseInt(req.query.weekNumber) : undefined,
