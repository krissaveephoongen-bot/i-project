// Create data using correct service role key
const { createClient } = require('@supabase/supabase-js');

// New Supabase service role key (admin privileges)
const supabaseUrl = 'https://vaunihijmwwkhqagjqjd.supabase.co';
const serviceRoleKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZhdW5paGlqbXd3a2hxYWdqcWpkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTMzMTYzNywiZXhwIjoyMDg2OTA3NjM3fQ.5y9iB5QK8L2eX3m7n8wR6pF9sT1kL2jH3gV4cY8wZ7k';

async function createDataDirect() {
  console.log('🔄 สร้างข้อมูลด้วย Service Role Key (Direct Supabase Client)...\n');
...
createDataDirect().catch(console.error);
