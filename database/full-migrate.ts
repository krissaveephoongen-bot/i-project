...
async function runFullMigrations() {
  ...
  try {
    console.log('📋 Creating all tables and types...\n');
    ...
    try {
      ...
      console.log('✅ Activity type enum already exists');
    }
    ...
    try {
      ...
      console.log('✅ Work type enum already exists');
    }
    ...
    try {
      ...
      console.log('✅ Expense category enum already exists');
    }
    ...
    try {
      ...
      console.log('✅ Expense status enum already exists');
    }
...
runFullMigrations().catch(console.error);
