function SCurveChart({ projectId }) {
  try {
    ...
    if (loading) {
      return (
        <div className="card" data-name="scurve-chart" data-file="components/SCurveChart.js">
    ...
    return (
      <div className="card" data-name="scurve-chart" data-file="components/SCurveChart.js">
        <h3 className="text-lg font-semibold mb-4">S-Curve: Plan vs Actual (Worklog-based)</h3>
        <div className="h-80">
