function ProjectProgress({ projects }) {
  try {
    ...
    return (
      <div className="card" data-name="project-progress" data-file="components/ProjectProgress.js">
          ...
          {activeProjects.map(project => (
            ...
            >
              ...
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="text-[var(--text-secondary)]">Actual Progress</span>
                <div className="flex items-center space-x-2">
                  <span className="font-semibold text-[var(--primary-color)]">{project.progress}%</span>
                  {project.progress >= 75 && (
              ...
              <div className="flex items-center justify-between text-xs text-[var(--text-secondary)]">
                <div className="flex items-center">
                  ...
                  <span>{new Date(project.dueDate).toLocaleDateString('th-TH')}</span>
                </div>
                <div className="flex items-center">
