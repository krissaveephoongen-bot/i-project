...
async function generateSQL() {
  ...
  console.log('-- Insert users SQL statements');
  ...
  users.forEach(user => {
    ...
    const sql = `INSERT INTO users (
      id, email, password, name, role, position, employee_code, department,
      is_active, is_deleted, failed_login_attempts, created_at, updated_at
    ) VALUES (
      '${user.id}',
      '${user.email}',
      '${hashedPassword}',
      ...
      ${user.employeeCode ? `'${user.employeeCode}'` : 'NULL'},
